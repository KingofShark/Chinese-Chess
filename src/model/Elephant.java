...
//        Nước đi của tượng sẽ không hợp lệ khi có một quân cờ nằm chặn giữa đường đi.
        ...
        if((_COLOR_ == BLACK)){
            ...
            //
            if (locateY - 1 > 0 && locateX - 1 > 0 && !check.isEmpty(locateX - 2, locateY - 2) && check.isEmpty(locateX - 1, locateY - 1) && pieces.elementAt(check.getPiece(locateX - 2, locateY - 2))._COLOR_ != _COLOR_) {
            ...
            if (locateY + 1 < 0 && locateX + 1 < 8 && !check.isEmpty(locateX + 2, locateY - 2) && check.isEmpty(locateX + 1, locateY - 1) && pieces.elementAt(check.getPiece(locateX + 2, locateY - 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX + 2, locateY - 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX + 2, locateY - 2)).changeImage();
            }
            if (locateY + 1 < 4 && locateX - 1 > 0 && !check.isEmpty(locateX - 2, locateY + 2) && check.isEmpty(locateX - 1, locateY + 1) && pieces.elementAt(check.getPiece(locateX - 2, locateY + 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX - 2, locateY + 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX - 2, locateY + 2)).changeImage();
            }
            if (locateY + 1 < 4 && locateX + 1 < 8 && !check.isEmpty(locateX + 2, locateY + 2) && check.isEmpty(locateX + 1, locateY + 1) && pieces.elementAt(check.getPiece(locateX + 2, locateY + 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX + 2, locateY + 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX + 2, locateY + 2)).changeImage();
            }
        } else {
            ...
            //
            if (locateY > 5 && locateX - 1 > 0 && !check.isEmpty(locateX - 2, locateY - 2) && check.isEmpty(locateX - 1, locateY - 1) && pieces.elementAt(check.getPiece(locateX - 2, locateY - 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX - 2, locateY - 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX - 2, locateY - 2)).changeImage();
            }
            if (locateY > 5 && locateX + 1 < 8 && !check.isEmpty(locateX + 2, locateY - 2) && check.isEmpty(locateX + 1, locateY - 1) && pieces.elementAt(check.getPiece(locateX + 2, locateY - 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX + 2, locateY - 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX + 2, locateY - 2)).changeImage();
            }
            if (locateY + 1 < 9 && locateX - 1 > 0 && !check.isEmpty(locateX - 2, locateY + 2) && check.isEmpty(locateX - 1, locateY + 1) && pieces.elementAt(check.getPiece(locateX - 2, locateY + 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX - 2, locateY + 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX - 2, locateY + 2)).changeImage();
            }
            if (locateY + 1 < 9 && locateX + 1 < 8 && !check.isEmpty(locateX + 2, locateY + 2) && check.isEmpty(locateX + 1, locateY + 1) && pieces.elementAt(check.getPiece(locateX + 2, locateY + 2))._COLOR_ != _COLOR_) {
                chooses.add(pieces.elementAt(check.getPiece(locateX + 2, locateY + 2)).TYPE);
                pieces.elementAt(check.getPiece(locateX + 2, locateY + 2)).changeImage();
            }
        }
