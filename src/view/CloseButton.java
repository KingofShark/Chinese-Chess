...
public class CloseButton {
    ...
    public void setClose(JPanel panel){
        ImageIcon imageIcon = new ImageIcon(System.getProperty("user.dir") + "/resource/image/closebutton/close.png");
    ...
    public void setHide(JPanel panel){
        ImageIcon imageIcon = new ImageIcon(System.getProperty("user.dir") + "/resource/image/closebutton/hide.png");
        imageIcon = new NewImage().resizeImage(imageIcon, 25, 25);
