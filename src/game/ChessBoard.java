...
public class ChessBoard extends JPanel implements Piece {
    ...
    public ChessBoard() {
        ...
        ImageIcon image = new ImageIcon(System.getProperty("user.dir") + "/src/image/menu/back.png");
        image = new NewImage().resizeImage(image, 35, 35);
        this.back.setIcon(image);
        this.back.setLocation(CELL_SIZE * 13, CELL_SIZE * 5 + CELL_SIZE / 4);
        ...
        this.pause = true;
        this.setBackground(new Color(238, 234, 234));
    ...
    private void backLastMove(JButton button) {
        this.back.addActionListener(e -> {
            if (!IOFile.checkFile(System.getProperty("user.dir") + "/src/file/lastmove.txt"))
                return;
            this.pause = true;
